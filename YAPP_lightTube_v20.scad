...
inspectX            = 11;        //-> 0=none (>0 from front, <0 from back)
...
pcbStands =    [
             ...
             //   , [5, 5, 4, 4, 9, yappBoth, yappBackLeft]
                  [5, 5, 4, 4, 9, yappBaseOnly, yappFrontLeft]
                , [5, 5, 4, 4, 9, yappBaseOnly, yappBackRight]
               ];
...
pushButtons = [
              //--- 0,  1, 2, 3, 4, 5, 6, 7,   8
              //  [15, 12, 8, 8, 0, 3, 1, 3.5, yappCircle]
              //, [15, 28, 8, 6, 2, 4, 1, 3.5, yappRectangle]
              ];     
